...
btn_on_sensore = tk.Button(frame, text="Accendi Sensore", font=("Courier", 14), command=lambda: write_on_serial('S'))
btn_off_sensore = tk.Button(frame, text="Spegni Sensore", font=("Courier", 14), command=lambda: write_on_serial('s'))
